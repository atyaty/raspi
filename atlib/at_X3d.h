...
//------------------------------------------------------------------------------------------------------------------------------------------
#define AT_X3ERROR_FRAMEOUT_CRC  0x04     //ramki błędów zwróconych z poziomu X3 mają status oddzielnego urządzenia
#define AT_X3ERROR_OUTBUFLEN      6
//-------------------------------------------------------------------------------------------------------------------------------------------
//   Funkcje,
...
#define AT_MOTOR_INBUFLEN            16 //12  +  4
...
#define AT_PWM_AI_RCMIN      0x02    //2
#define AT_PWM_AI_RCMAX      0x04    //4
#define AT_PWM_AI_WIDTHA     0x06    //6
#define AT_PWM_AI_WIDTHB     0x08    //8
#define AT_PWM_AI_WIDTHC     0x0a    //10
#define AT_PWM_AI_WIDTHD     0x0c    //12
#define AT_PWM_FRAMEIN_CRC   0x0e    //14
#define AT_PWM_INBUFLEN         20   //16 + 4
...
#define AT_HELI_INBUFLEN          16    //12 + 4
...
#define AT_TIMER_INBUFLEN          20            //16  + 4
...
//-----------------------------------
#define AT_WAVE_AI_FREQ                 0x00   //0
#define AT_WAVE_AI_SHAPEFREQ            0x02   //2
#define AT_WAVE_FRAMEIN_CRC             0x04   //4
#define AT_WAVE_INBUFLEN                    10 //6 +4

#define AT_WAVE_AO_TC           0x00    //0
#define AT_WAVE_AO_PER          0x02    //2
#define AT_WAVE_AO_FREQ         0x04    //4
#define AT_WAVE_AO_SHAPEFREQ    0x06    //6
#define AT_WAVE_FRAMEOUT_CRC    0x08    //8
#define AT_WAVE_OUTBUFLEN          14   //10 + 4
