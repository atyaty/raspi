...
int initX3(){
    ...
    X3Wave     = new atI2C_X3("WAVE",AT_MODBUS_ID_X3,AT_REGADRES_WAVE);
...
//-------------------------------------------------------------------
void initVars(){
    FileRap= new atFileLog("/var/log/x3_test","x3_test",".log",AT_LOG_ZAWSZE);
    Rap("program X3 test");
...
int main(int argc, char *argv[]) {
    ...
    kal->confRap(FileRap,AT_LOG_DEBUG);
    kal->setDev(X3Motor,X3Wave);
